...
$Output = $results | Select-Object DisplayName, AccountEnabled, UserType, JobTitle, Department, CompanyName, StreetAddress, City, PostalCode, State, Country, officelocation, BusinessPhones, MobilePhone, Mail, GivenName, Surname, CreatedDateTime, @{Name='StartDate (Aho)'; Expression={$_.'StartDate'}}, UserPrincipalName, @{Name='EmployeeCategory (Aho)'; Expression={$_.'EmployeeCategory'}}, M365E3, M365E5, NoLicense, UsageLocation, LastSignInDateTime, passwordPolicies, RoomMailbox, SharedMailbox, ID, SecurityIdentifier | Sort-Object DisplayName
