...
#Blacklist Not allowed resource types (Policy Defnition)
#Whitelist-Allowed resource types (Policy Defnition)



$definition = Get-AzPolicyDefinition -name bba2f932-0b62-48cb-a321-d3d5c6eb2acc 
#"/subscriptions/0fc3e508-28eb-427a-b4fa-f78bdc39f2c6/providers/Microsoft.Authorization/policyDefinitions/bba2f932-0b62-48cb-a321-d3d5c6eb2acc"
