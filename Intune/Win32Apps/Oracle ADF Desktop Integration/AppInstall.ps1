<#
.APP: Oracle ADF Desktop Integration Add-In for Excel 
.AUTHOR: Ashley Forde
.DATE: 16 May 2023
#>
...
$AppName=[string]'Oracle ADF Desktop Integration Add-In for Excel'
$AppVersion="5.1.1.24107"
$AppValidationFile="$validation\$AppName.txt"
$AppLog="$logs\$AppName.log"
$AppInstallFile= "adfdi.exe"
