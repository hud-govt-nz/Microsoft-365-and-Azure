...
$AppName = [string]'Adobe Acrobat Reader'
$AppVersion = "22.003.20282"
$AppValidationFile = "$validation\$AppName.txt"
$AppLog = "$logs\$AppName.log"
$AppInstallFile = "AcroRdrDC2200320282_en_US.exe"
$AppInstallArguments ="/sAll /rs /rps /msi /norestart /quiet EULA_ACCEPT=YES"
