...
$AppName=[string]'Pandoc 3.1.2'
$AppVersion="3.1.2"
$AppValidationFile="$validation\$AppName.txt"
$AppLog="$logs\$AppName.log"
$AppInstallFile= "pandoc-3.1.2-windows-x86_64.msi"
$AppInstallArguments='/quiet'
        ...
        if ($Result) {
            try {
                # Uninstall App
                    ...
                    $uninstallProcess = Start-Process MsiExec.exe -ArgumentList $Result -PassThru -Wait -ErrorAction Stop
