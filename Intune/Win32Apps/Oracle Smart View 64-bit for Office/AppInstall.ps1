<#
.APP: Oracle Smart View 64-bit for Office 
.AUTHOR: Ashley Forde
.DATE: 16 May 2023
#>
...
$AppName=[string]'Oracle Smart View 64-bit for Office'
$AppVersion="22.200"
$AppValidationFile="$validation\$AppName.txt"
$AppLog="$logs\$AppName.log"
$AppInstallFile= "SmartView.msi"
$AppInstallArguments='/qb'
    ...
    'uninstall' {
        if ($Result) {
            try {
                ...
                $Result = (($Result.UninstallString -split ' ')[1] -replace '/I','/X ') + ' /qb'
