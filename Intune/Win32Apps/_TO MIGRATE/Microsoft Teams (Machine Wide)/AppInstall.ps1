<#
.APP: Microsoft Teams (Machine Wide)
.AUTHOR: Ashley Forde
.DATE: 17 May 2023
#>
...
$AppName=[string]'Teams Machine-Wide Installer'
$AppVersion="1.6.00.11166"
$AppValidationFile="$validation\$AppName.txt"
$AppLog="$logs\$AppName.log"
$AppInstallFile= "Teams_windows_x64.msi"
$AppInstallArguments='ALLUSERS=1 /qn'
