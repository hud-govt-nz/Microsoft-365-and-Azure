...
.EXAMPLE 
    powershell.exe -executionpolicy bypass -file .\AzureRM Modules.ps1 -Mode Install
    powershell.exe -executionpolicy bypass -file .\AzureRM Modules.ps1 -Mode Uninstall
