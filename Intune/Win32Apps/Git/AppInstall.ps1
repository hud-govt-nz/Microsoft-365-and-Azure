...
$AppInstallFile= "Git-2.40.1-64-bit.exe"
$AppInstallArguments='/VERYSILENT /NORESTART /NOCANCEL /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS'
...
switch ($args[0]) {
    ...
    'uninstall' {
        if ($Result) {
            try {
                # Uninstall App
                $uninstall_command = "C:\Program Files\Git\unins000.exe" 
