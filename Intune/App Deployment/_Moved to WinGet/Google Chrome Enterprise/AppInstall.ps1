...
.DESCRIPTION
    Script to install Google Chrome Enterprise
...
$AppVersion = "125.0.6422.142"
$Installer = "GoogleChromeStandaloneEnterprise64.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/qn /norestart ALLUSERS=1 GOOGLE_CHROME=1" # Optional
...
switch ($Mode) {
    ...
    "Uninstall" {
        try {
            ...
            $Result = (($AppToUninstall.UninstallString -split ' ')[1]) + ' /qn'
