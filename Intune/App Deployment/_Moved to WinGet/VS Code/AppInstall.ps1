...
$AppVersion = "1.90.2"
$Installer = "VSCodeSetup-x64-1.90.2.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/VERYSILENT /NORESTART /NOCANCEL /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS /SUPPRESSMSGBOXES /mergetasks=!runcode" # Optional
$UninstallArguments = "/VERYSILENT" # Optional
