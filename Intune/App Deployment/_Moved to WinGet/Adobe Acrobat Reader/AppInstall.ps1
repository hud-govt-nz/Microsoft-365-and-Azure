...
.DESCRIPTION
    Script to install Adobe Acrobat Reader
...
$AppVersion = "24.2.20759.0"
$Installer = "AcroRead.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
