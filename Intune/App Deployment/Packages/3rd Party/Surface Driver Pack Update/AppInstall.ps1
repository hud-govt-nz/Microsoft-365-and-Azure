<#
.SYNOPSIS
    Surface Device Driver Pack Installation Script

.DESCRIPTION
    Script to install Surface Device Driver Pack. This can be for any Surface device.
...
$AppName = "Surface Laptop 4"
$AppVersion = "24.052.21627.0"
$Installer = "SurfaceLaptop4_Intel_Win11_22621_24.052.21627.0.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/qb /norestart" # Optional
