<#
.SYNOPSIS
    Land Online - DC loader

.DESCRIPTION
    Script to install Land Online - DC loader
...
$AppName = "DC Loader"
$AppVersion = "3.1.13"
$Installer = "dcloader3.1.13.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
