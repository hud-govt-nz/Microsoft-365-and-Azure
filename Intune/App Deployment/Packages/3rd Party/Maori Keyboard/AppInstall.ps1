<#
.SYNOPSIS
    Maori Keyboard Driver

.DESCRIPTION
    Script to install Maori Keyboard Driver - per Jira Ticket SUPPORT-894
...
$AppVersion = "1.0.3.40"
$Installer = "EngTRkb_amd64.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/q" # Optional
