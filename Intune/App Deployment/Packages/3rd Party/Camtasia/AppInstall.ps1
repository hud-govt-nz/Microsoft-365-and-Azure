...
.DESCRIPTION
    Script to install Camtasia 2024
...
$AppName = "Camtasia"
$AppVersion = "2024"
$Installer = "camtasia.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
    ...
    "Install" {
        try {
            ...
            try {
                ...
                $InstallArguments = "TRANSFORMS=$SetupFolder\camtasia.mst /quiet /norestart" # Optional
