...
.DESCRIPTION
    Script to install Pandoc Document Converter
...
$AppName = "Pandoc"
$AppVersion = "3.2.1"
$Installer = "pandoc-3.2.1-windows-x86_64.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "/qn /norestart ALLUSERS=1" # Optional
