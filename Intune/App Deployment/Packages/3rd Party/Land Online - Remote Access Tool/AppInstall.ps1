<#
.SYNOPSIS
    Land Online - Remote Access Tool

.DESCRIPTION
    Script to install Land Online - Remote Access Tool
...
$AppName = "Remote Access Tool - Toitu Te Whenua"
$AppVersion = "7.51.1054"
$Installer = "Remote-Access-Installer_ToituTeWhenua7-51.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
