...
.DESCRIPTION
    Script to install Visual Studio Community 2022
...
$AppVersion = "17.10.35027.167"
$Installer = "vs_Community.exe" # assumes the .exe or .msi installer is in the Files folder of the app package.
$InstallArguments = "--quiet --wait --norestart --nocache --installPath C:\VS2022" # Optional
