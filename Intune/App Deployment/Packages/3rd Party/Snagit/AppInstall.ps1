...
$AppName = "Snagit"
$AppVersion = "2024"
$Installer = "snagit.msi" # assumes the .exe or .msi installer is in the Files folder of the app package.
    ...
    "Install" {
        try {
            ...
            try {
                ...
                $InstallArguments = "TRANSFORMS=$SetupFolder\snagit.mst /quiet /norestart" # Optional
