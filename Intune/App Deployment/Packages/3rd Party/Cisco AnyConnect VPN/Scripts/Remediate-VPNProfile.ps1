...
try {
    ...
    Set-Content -Path $targetPath -Value $xmlContent -Force
    Write-Output "Successfully updated VPN profile"
    exit 0
} catch {
    Write-Error "Failed to update VPN profile: $_"
    exit 1
}