...
$URL = "https://mhud.sharepoint.com/sites/safetywb"
$ListTitle = "lad"
$ContentTypesToHide =@('Folder','Visio drawing','Forms for Excel','Visio drawing','eDocument','email')

Set-NewMenuOnList -URL:$URL -ListTitle:$ListTitle -ContentTypesToHide:$ContentTypesToHide