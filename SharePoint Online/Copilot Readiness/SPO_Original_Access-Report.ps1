...
# Start processing sites
  ...
  Connect-PnPOnline -Url $_.Url -ClientId $env:DigitalSupportAppID -Tenant 'mhud.onmicrosoft.com' -Thumbprint $env:DigitalSupportCertificateThumbprint
