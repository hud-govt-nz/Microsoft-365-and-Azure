Clear-Host
Write-host "## SharePoint Online Reporting: Move Folders Between Sites/Libraries ##" -ForegroundColor Yellow
...
Write-Host "Connecting to https://mhud-admin.microsoft.com" -ForegroundColor Yellow
